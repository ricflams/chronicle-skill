...
Older sessions moved from session-log.md to keep that file under 300 lines.

---

## 2025-02-01 - Session 1: Initial Design & Implementation (~4 hours)
...
Made 8 architectural decisions during this session. See `.chronicle/context/decisions-archive/` for full historical ADRs:
- 0001-bootstrap-and-exit - Skill transfers knowledge and exits
- 0002-protocols-in-claude-md - Protocols in CLAUDE.md for reliability
- 0003-10-file-structure - Consolidated from 18 to 10 files
- 0004-chronicle-naming - "Chronicle" over "regenerative-memory"
- 0005-chronicle-directory - `.chronicle/` directory name
- 0006-completed-tasks-exclusion - Exclude from AI context
- 0007-active-tasks-elevation - Active tasks at top level
- 0008-universal-auto-detect - Auto-detect project type
